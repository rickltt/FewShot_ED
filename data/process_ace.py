...
# ACE_EVENTS = ['Attack', 'Elect', 'Injure', 'Die', 'Marry', 'End-Position', 'Divorce', 'Be-Born', 'Release-Parole', 'Phone-Write', 'Trial-Hearing', 'Transport', 'Appeal', 'Extradite', 'Transfer-Money', 'Start-Position', 'Charge-Indict', 'Arrest-Jail', 'Sue', 'Transfer-Ownership', 'Convict', 'Execute', 'Declare-Bankruptcy', 'Demonstrate', 'Sentence', 'Meet', 'Merge-Org', 'Start-Org', 'End-Org', 'Nominate', 'Fine', 'Acquit', 'Pardon']
# ACE_EVENTS.remove("Acquit")
# ACE_EVENTS.remove("Pardon")
# ACE_EVENTS.remove("Extradite")
...
train_event = classes[:10]

new_classes = classes[10:]
random.shuffle(new_classes)

dev_event = new_classes[:10]
test_event = new_classes[10:]
