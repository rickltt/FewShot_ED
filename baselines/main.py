...
from model import UnifiedModel, PACRF, VanillaCRF
...
def evaluate(args, model, eval_dataloader, eval_epoch):
    ...
    with torch.no_grad():
        for _ in eval_iterator:
            ...
            metric.update_state(pred, query_set['label_ids'], id2label)
...
def main():
    ...
    parser.add_argument('--seed', default=42, type=int, 
                        help='seed')
    parser.add_argument('--data_dir', default='../data/fewevent', type=str)
    ...
    if args.do_eval:
        ...
        result = '***** Model: {} , Dataset:{}, N:{}, K:{}, seed:{} *****\n'.format(args.model, dataset_name, args.N, args.K, args.seed)
